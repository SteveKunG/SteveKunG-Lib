package com.stevekung.stevekunglib.forge.client.event.handler;

import com.stevekung.stevekunglib.forge.config.SteveKunGLibConfig;
import com.stevekung.stevekunglib.forge.core.SteveKunGLibForge;
...
public class ClientEventHandler
{
    ...
    {
        if (this.mc.player != null && SteveKunGLibConfig.GENERAL.enableVersionChecker.get())
        {
