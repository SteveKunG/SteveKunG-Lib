...
//
//    @Override
//    public boolean func_212867_a_(IChunk world, Random rand, int chunkX, int chunkZ, int originalX, int originalZ, int p_212867_7_, BitSet bitSet, ProbabilityConfig config)
//    {
//        int i = (this.func_222704_c() * 2 - 1) * 16;
//        double d0 = (double)(chunkZ * 16 + rand.nextInt(16));
//        double d1 = (double)(rand.nextInt(rand.nextInt(40) + 8) + 20);
//        double d2 = (double)(originalX * 16 + rand.nextInt(16));
...
//        int k = 0;
//        this.func_222729_a(world, rand.nextLong(), chunkX, chunkZ, p_212867_7_, d0, d1, d2, f2, f, f1, 0, j, 3.0D, bitSet);
//        return true;
//    }
//
//    @Override
