...
public class IteratableSettings<T extends Settings> extends AbstractSettings<T>
{
    ...
    private final BiFunction<T, IteratableSettings<T>, ITextComponent> getter;

    public IteratableSettings(String translationKey, BiConsumer<T, Integer> setter, BiFunction<T, IteratableSettings<T>, ITextComponent> getter)
    {
